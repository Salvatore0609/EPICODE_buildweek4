...
public class Main {
    public static void main(String[] args) {
        ...
        Tratta milanoRoma = new Tratta(null, "Milano", "Roma", LocalDateTime.of(2025,3,31,10,30,00), LocalDateTime.of(2025,3,31,15,30,00), 360.00);
        Mezzo autobus1 = new Autobus(null, milanoRoma, 5, 2);
        Mezzo tram1 = new Tram(null, milanoRoma, 5, 2);
