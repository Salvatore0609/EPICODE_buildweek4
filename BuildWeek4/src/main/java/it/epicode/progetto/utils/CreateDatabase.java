...
public class CreateDatabase {
    public static void main(String[] args) {
        ...
        Autobus autobus = new Autobus(null, null, 0, 2, 20, Stato.FERMO, LocalDate.of(2025, 04, 03), LocalDate.of(2025, 05, 03));
        Autobus autobus1 = new Autobus(null, null, 0, 4, 20, Stato.IN_SERVIZIO, LocalDate.of(2025, 04, 03), LocalDate.of(2025, 06, 03));
        Autobus autobus2 = new Autobus(null, null, 0, 3, 20, Stato.IN_SERVIZIO, LocalDate.of(2025, 04, 03), LocalDate.of(2025, 06, 03));
        Autobus autobus3 = new Autobus(null, null, 0, 2, 20, Stato.FERMO, LocalDate.of(2025, 04, 03), LocalDate.of(2025, 05, 03));
        Autobus autobus4 = new Autobus(null, null, 0, 1, 20, Stato.IN_MANUTENZIONE, LocalDate.of(2025, 04, 03), LocalDate.of(2025, 04, 13));
        Tram tram = new Tram(null, null, 0, 1, 50, Stato.IN_SERVIZIO, LocalDate.of(2025, 04, 03), LocalDate.of(2025, 06, 03));
        Tram tram1 = new Tram(null, null, 0, 1, 50, Stato.FERMO, LocalDate.of(2025, 04, 03), LocalDate.of(2025, 05, 03));
        Tram tram2 = new Tram(null, null, 0, 1, 50, Stato.IN_SERVIZIO, LocalDate.of(2025, 04, 03), LocalDate.of(2025, 06, 03));
        Tram tram3 = new Tram(null, null, 0, 1, 50, Stato.IN_MANUTENZIONE, LocalDate.of(2025, 04, 03), LocalDate.of(2025, 04, 13));
