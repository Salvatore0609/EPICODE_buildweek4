...
public class ProvaMainScelte {
    ...
    Scanner scanner = new Scanner(System.in);
        System.out.println("Benvenuti nel parco mezzi del Team 6! Qui hai la possibilità di creare dei nuovi veicoli, tratte e percorsi personalizzati.");
    ...
    Integer sceltaPresa = scanner.nextInt();


        switch (sceltaPresa) {
        case 1:
            System.out.println("Hai scelto di creare un mezzo. Inserisci i dettagli:");
            ...
            if (sceltaMezzo == 1) {
                ...
                System.out.println("Inserisci la capienza di persone nell'autobus:");
                Integer capienzaAutobus = scanner.nextInt();
                System.out.println("Quante persone ci sono effettivamente a bordo?");
                Integer personeAboard = scanner.nextInt();
                Mezzo autobus = new Autobus(null, null, Stato.FERMO, personeAboard, 1, capienzaAutobus);
                ...
                System.out.println("Inserisci la capienza di persone nel tram:");
                Integer capienzaTram = scanner.nextInt();
                System.out.println("Quante persone ci sono effettivamente a bordo?");
                Integer personeAboardTram = scanner.nextInt();
                Mezzo tram = new Tram(null, null, Stato.FERMO, personeAboardTram, 1, capienzaTram);
