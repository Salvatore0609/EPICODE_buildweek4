...
public class Autobus extends Mezzo {
	...
	public String toString() {
		...
		if (getStatoEnum() == Stato.IN_SERVIZIO && getTratta() != null
			...
			return "Autobus " + azzurro + "ATEB" + reset + " linea " + getId() + " attualmente " + verde
			...
			return "Autobus " + azzurro + "ATEB" + reset + " linea " + getId() + " attualmente " + rosso
			...
			return "Autobus " + azzurro + "ATEB" + reset + " linea " + getId() + " attualmente " + giallo
