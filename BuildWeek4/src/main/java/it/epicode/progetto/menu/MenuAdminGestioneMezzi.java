			...
			switch (sceltaPresa) {
				case 1 :
					...
					if (sceltaMezzo == 1) {
						...
						System.out.println("Quante persone ci sono a bordo? (Massimo 20 persone)");
						Integer personeAboard = scanner.nextInt();
						Mezzo autobus = new Autobus(null, null, personeAboard, 0, 20, Stato.FERMO, null, null);
						...
						System.out.println("Quante persone ci sono a bordo? (Massimo 50 persone)");
						Integer personeAboardTram = scanner.nextInt();
						Mezzo tram = new Tram(null, null, personeAboardTram, 0, 20, Stato.FERMO, null, null);
